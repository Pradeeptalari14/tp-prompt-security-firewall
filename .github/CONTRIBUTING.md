...
Thank you for your interest in improving the **PromptSecurity (Firewall)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-prompt-security-firewall.git
...
Generated configurations come from the **[PromptSecurity (Firewall) Studio](https://pradeeptalari14.github.io/portfolio/tools/prompt-security-firewall/)**.
