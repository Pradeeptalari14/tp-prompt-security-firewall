# 🔧 Troubleshooting Guide — PromptSecurity (Firewall)
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-prompt-security-firewall/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/prompt-security-firewall/)
