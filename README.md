...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/prompt-security-firewall/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-prompt-security-firewall.git
cd tp-prompt-security-firewall
```
...
```bash
kubectl port-forward deployment/tp-prompt-security-firewall 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── firewall_config.json     # Main configuration file
```
...
---
*Generated by [PromptSecurity (Firewall) Studio](https://pradeeptalari14.github.io/portfolio/tools/prompt-security-firewall/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
